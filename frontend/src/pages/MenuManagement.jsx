      ...
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-center">
          <h6 className="card-title">
            <i className="bi bi-folder-fill me-2 icon-primary"></i>
            Menu Management
          </h6>
          <button
              ...
              <div className="row g-3 align-items-center">
                ...
                <div className="col-12 col-md-4">
                  <label className="form-label fw-semibold d-flex align-items-center gap-1" htmlFor="searchInput">
                    <i className="bi bi-box-seam "></i> Cabinet
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  <label className="form-label fw-semibold text-muted d-flex align-items-center gap-1" htmlFor="searchInput">
                    <i className="bi bi-menu-button-wide "></i> Menu Type
                  </label>
                  <CustomSelect
                ...
                <div className="col-12 col-sm-6 col-md-3">
                  ...
                  >
                    <i className="bi bi-search"></i> Search Menus
                  </label>
                ...
                filteredTreeData.length > 0 ? (
                  ...
                  showNoData && <div className="enhanced-alert">
                    ...
                    >
                      ...
                      <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 .877-.252 1.024-.598l.088-.416c.066-.31.168-.463.323-.463.176 0 .319.128.319.445 0 .252-.088.516-.352.7l-.088.076-.002.002-.002.003c-.237.276-.625.416-1.036.416-.805 0-1.324-.503-1.176-1.368l.738-3.468c.194-.897-.105-1.319-.808-1.319-.545 0-.877.252-1.024.598l-.088.416c-.066.31-.168.463-.323.463-.176 0-.319-.128-.319-.445 0-.252.088-.516.352-.7l.088-.076zM8 5.5a.75.75 0 1 1 0-1.5.75.75 0 0 1 0 1.5z" />
                    </svg>
